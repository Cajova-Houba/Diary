<%@ include file="/common/taglibs.jsp"%>
 ...
 <!-- This form is used for editing an existing activity -->
 
<head>
    <title>${activity.name }</title>
</head>

<form:form commandName="activity" method="post" action="/activity/edit" cssClass="well" id="planForm">
	<div class="well">
		<form:hidden path="ID" id="ID"/>
		<form:hidden path="dailyRecord.ID" id="drID"/>
